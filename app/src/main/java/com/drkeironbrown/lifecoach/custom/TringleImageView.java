...
public class TringleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public TringleImageView(Context context) {
        super(context);

        init();
    }

    public TringleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TringleImageView(Context context, AttributeSet attrs, int defStyle) {
