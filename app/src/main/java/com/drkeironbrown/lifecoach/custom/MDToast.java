...
public class MDToast extends Toast {
    ...
    public static MDToast makeText(Context context, String message, int duration, int type) {
        ...
        text.setTypeface(Functions.getRegularFont(context));
        switch (type) {
            case TYPE_SUCCESS:
                icon.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_circle_with_check_symbol));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    view.setBackground(ContextCompat.getDrawable(context, R.drawable.custom_toast_success_background));
                } else
                    view.setBackgroundColor(ContextCompat.getColor(context, R.color.darkColor));
                break;
            case TYPE_WARNING:
            ...
            case TYPE_ERROR:
                ...
                break;
            default:
                icon.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_icon));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    view.setBackground(ContextCompat.getDrawable(context, R.drawable.custom_toast_info_background));
                } else view.setBackgroundColor(ContextCompat.getColor(context, R.color.darkColor));
                break;
        }
